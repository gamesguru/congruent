...
complement args=".":
    ...
    env COMPLEMENT_ALWAYS_PRINT_SERVER_LOGS=1 COMPLEMENT_BASE_IMAGE="continuwuity:complement" COMPLEMENT_HOST_MOUNTS="$MOUNTS" COMPLEMENT_RUN="{{args}}" RESULTS_DIR="{{env_var_or_default("COMPLEMENT_RESULTS_DIR", "tests/complement")}}" ./bin/complement ./complement-src
